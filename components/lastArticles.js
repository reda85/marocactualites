...
<div className="posts">
    {Lastposts.map((post,i) => {
        ...
        return(<article key={i}>
            <a style={{marginBottom : "10px", paddingBottom: '0px'}} href={`${api_base}/ownarticles/${post.slug}`} className="image"><h3 style={{marginBottom : "0px", paddingBottom: '0px'}}>{post.title}</h3></a>
