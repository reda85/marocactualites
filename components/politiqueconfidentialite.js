...
function PolitiqueConfidentialite () {
 ...
 <p>Vous pouvez à tout moment choisir de désactiver tout ou partie des Cookies. Votre navigateur peut également être paramétré pour vous signaler les Cookies déposés dans votre terminal et vous demander de les accepter ou non (au cas par cas ou en totalité). Nous vous rappelons toutefois que la désactivation de tous les Cookies vous empêchera d’utiliser notre site dans des conditions normales, à l’exception des fonctions basiques.</p>
  ...
  <p>Si vous utilisez le navigateur Firefox : cliquez sur l&lsquo;icône du Menu Firefox, puis sur le bouton Outils, puis Options ; dans la fenêtre qui s&lsquo;affiche, choisissez Vie Privée et cliquez sur Supprimez Cookies Spécifiques. Sélectionnez les Cookies que vous souhaitez désactiver puis supprimez-les.</p>
  
  <p>Si vous utilisez le navigateur Safari : cliquez sur le bouton Paramètres, puis Préférences. Dans la fenêtre qui s&lsquo;affiche, choisissez Confidentialité/Sécurité, et cliquez sur Afficher les Cookies. Sélectionnez les Cookies que vous souhaitez désactiver puis clic sur Effacer ou sur Tout effacer.</p>
  
  <p>Si vous utilisez le navigateur Chrome : cliquez sur l&lsquo;icône du menu Google Chrome, puis Paramètres. Au bas de la page, cliquez sur Afficher les paramètres avancés. Dans la section Confidentialité, cliquez sur Paramètre de contenus. Pour désactiver les cookies :
 Sélectionnez Interdire à tous les sites de stocker des données
 Cliquez sur Cookies et données de site, puis passez la souris sur le site ayant créé le Cookie, et cliquez sur X dans l’angle droit, ou cliquez sur Tout supprimer.</p>
  
  
 <strong>2. Refuser un Cookie d’audience </strong>
 ...
 <ul>
 <li>http://www.nugg.ad/fr/protection-des-donnees/informations-generales.html</li>
 <li>ttps://tools.google.com/dlpage/gaoptout?hl=fr</li>
  </ul>
 <strong>Autres Cookies d’audience ?</strong>
 <ul>
 ...
 <ul>
 <li>Cookies DoubleClick for Publishers : https://www.google.com/settings/u/0/ads/authenticated</li>
 <li>Cookies Outbrain : http://www.outbrain.com/fr/legal/privacy</li>
 <li>Cookies Adyoulike : https://www.adyoulike.com/privacy_policy_fr.php </li>
 <li>Cookies Dailymotion : http://www.dailymotion.com/legal/cookiespolicy</li>
 <li>Cookies Quantum : http://quantum-advertising.com/adchoice.html#</li>
 <li>Cookies Taboola : https://www.taboola.com/cookie-policy</li>
 <li>Cookies SpotX : https://www.spotx.tv/privacy-policy/cookie-opt-out/</li>
 <li>Cookies Improve Digital : https://www.improvedigital.com/opt-out-page/</li>
 <li>Cookies Loopme : https://loopme.com/privacy/</li>
 <li>Cookies FirstImpression : http://www.firstimpression.com/privacy-policy</li>
 </ul> 
